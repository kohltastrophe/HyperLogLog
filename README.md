...
Adds an item to the counter. The item will be hashed.

- **`item`** (any): The item to add. This can be a `string`, `number`, or any other value that can be converted to a string.
...
counter:add("new_player_id")
print(counter:estimate())
```

## Credits

Thanks to [@XoifailTheGod](https://www.roblox.com/users/558808710) for helping fix and optimize the library.
